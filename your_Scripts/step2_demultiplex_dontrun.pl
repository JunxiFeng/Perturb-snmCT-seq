...
use File::Basename;
my $r1_dir = dirname($r1_in);
my $r1_base = basename($r1_in);
my $r2_base = basename($r2_in);

# Create output in fastq_demultip subdirectory of current working directory
mkdir "fastq_demultip" unless -d "fastq_demultip";
$r1_name = "fastq_demultip/$r1_base";
$r2_name = "fastq_demultip/$r2_base";
################################
...
# @r1_name=split(/_R1/, basename($r1_name));
# @r2_name=split(/_R2/, basename($r2_name));
@r1_name=split(/_R1/, $r1_name);  # Remove basename()
@r2_name=split(/_R2/, $r2_name);  # Remove basename()
